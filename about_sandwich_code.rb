...
class AboutSandwichCode < Neo::Koan
  ...
  def test_counting_lines
    assert_equal 4, count_lines('/Users/househappy/Sites/koans/example_file.txt')
  end
  ...
  def test_finding_lines
    assert_equal "test\n", find_line("/Users/househappy/Sites/koans/example_file.txt")
  end
  ...
  def test_counting_lines2
    assert_equal 4, count_lines2("/Users/househappy/Sites/koans/example_file.txt")
  end
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block
    assert_equal 4, count_lines3("/Users/househappy/Sites/koans/example_file.txt")
  end
